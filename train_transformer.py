...
def main(args):
    ...
    # data loading
    transforms = v2.Compose([v2.Resize((224,224)),v2.ToImage(),v2.ToDtype(torch.float32,scale = True),v2.Normalize(mean=[0.485, 0.456, 0.406],std=[0.229, 0.224, 0.225])])
    target_transforms = v2.Compose([v2.Resize((224,224)),v2.ToImage()])
    ...
    model.load_state_dict(torch.load('transformer_2.pth'))
